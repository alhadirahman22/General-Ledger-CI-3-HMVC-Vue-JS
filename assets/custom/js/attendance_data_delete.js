        ...
        $('#cuti_type').parent().append(`<div id="reguler_form" class="well"><div class="row">
            <div class="col-md-6">
                <div class="form-group">    
                    ...
                    <input type="number" name="reguler_minggu_kerja" id="reguler_minggu_kerja" class="form-control" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">    
                    <label><i>Jumlah Minggu Cuti</i></label>
                    <input type="number" name="reguler_minggu_cuti" id="reguler_minggu_cuti" class="form-control" />
                </div>
            </div>
            </div>
            </div>`);
