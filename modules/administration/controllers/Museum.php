...
class Museum extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->perm = 'administration/user_management/museum';
        $this->table_id_key = 'museum_id'; // 'warehouse_sub_id';
        ...
        $this->data['table'] = [
            'columns' => [
                '0' => ['name' => 'a.name', 'title' => 'Name', 'width' => '15%', 'filter' => ['type' => 'text'], 'class' => 'default-sort', 'sort' => 'asc'],
                '1' => ['name' => 'a.descriptions', 'title' => 'Deskripsi', 'filter' => ['type' => 'text'], 'class' => 'default-sort', 'sort' => 'asc'],
        ...
        if ($this->aauth->is_allowed($this->perm . '/edit') || ($this->aauth->is_allowed($this->perm . '/delete'))) {
            $this->data['table']['columns']['6'] = ['name' => 'id', 'title' => '', 'class' => 'no-sort text-center', 'width' => '5%', 'filter' => ['type' => 'action']];
        }
