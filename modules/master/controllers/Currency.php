...
class Currency extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->perm = 'master/currency';
        $this->table_id_key = 'currency' . '_id'; // 'warehouse_sub_id';
        ...
        $this->data['table'] = [
            'columns' => [
                '0' => ['name' => 'a.country', 'title' => 'Negara', 'width' => '15%', 'filter' => ['type' => 'text'], 'class' => 'default-sort', 'sort' => 'asc'],
                '1' => ['name' => 'a.code', 'title' => 'Kode', 'width' => '15%', 'filter' => ['type' => 'text'], 'class' => 'default-sort', 'sort' => 'asc'],
                '2' => ['name' => 'a.name', 'title' => 'Nama', 'width' => '15%', 'filter' => ['type' => 'text'], 'class' => 'default-sort', 'sort' => 'asc'],
                '3' => ['name' => 'a.symbol', 'title' => 'Simbol', 'filter' => ['type' => 'text'], 'class' => 'default-sort', 'sort' => 'asc'],
