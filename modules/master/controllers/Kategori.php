...

{
    ...
    {
        parent::__construct();
        $this->perm = 'master/kategori';
        $this->table_id_key = 'kategori_id'; // 'warehouse_sub_id';
        ...
        $this->data['table'] = [
            'columns' => [
                ...
                '1' => ['name' => 'a.prefix', 'title' => 'Prefix', 'width' => '15%', 'filter' => ['type' => 'text'], 'class' => 'default-sort', 'sort' => 'asc'],
                '2' => ['name' => 'a.name', 'title' => 'Nama', 'width' => '15%', 'filter' => ['type' => 'text'], 'class' => 'default-sort', 'sort' => 'asc'],
                '3' => ['name' => 'a.descriptions', 'title' => 'Deskripsi', 'filter' => ['type' => 'text'], 'class' => 'default-sort', 'sort' => 'asc'],
