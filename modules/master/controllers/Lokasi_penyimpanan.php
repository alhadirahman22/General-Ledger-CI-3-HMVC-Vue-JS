...
class Lokasi_penyimpanan extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->perm = 'master/lokasi_penyimpanan';
        $this->table_id_key = 'lokasi_penyimpanan' . '_id'; // 'warehouse_sub_id';
        ...
        $this->data['table'] = [
            'columns' => [
                '0' => ['name' => 'a.museum_id', 'title' => 'Museum', 'width' => '15%', 'filter' => ['type' => 'dropdown', 'options' => $this->m_master->get_dropdown_filter_museum('museums', 'museum_id', 'name')], 'class' => 'default-sort', 'sort' => 'asc'],
                '1' => ['name' => 'a.name', 'title' => 'Nama', 'width' => '15%', 'filter' => false, 'class' => 'default-sort', 'sort' => 'asc'],
                '2' => ['name' => 'a.descriptions', 'title' => 'Deskripsi', 'filter' => ['type' => 'text'], 'class' => 'default-sort', 'sort' => 'asc'],
                '3' => ['name' => 'a.parent_id', 'title' => 'Parent', 'filter' => ['type' => 'dropdown', 'options' => $this->m_master->get_dropdown_filter_museum('lokasi_penyimpanan', 'lokasi_penyimpanan_id', 'name')], 'class' => 'default-sort', 'sort' => 'asc'],
                '4' => ['name' => 'a.created_at', 'title' => lang('created_at'), 'filter' => false, 'class' => 'default-sort', 'sort' => 'asc'],
                '5' => ['name' => 'a.created_by', 'title' => lang('created_by'), 'filter' => false, 'class' => 'no-sort', 'sort' => 'asc'],
                '6' => ['name' => 'a.updated_at', 'title' => lang('updated_at'), 'filter' => false, 'class' => 'default-sort', 'sort' => 'asc'],
                '7' => ['name' => 'a.updated_by', 'title' => lang('updated_by'), 'filter' => false, 'class' => 'no-sort', 'sort' => 'asc'],
            ],
    ...
    public function form($token = '')
    {
        ...
        $form = [
            ...
            array(
                ...
                'form_control_class' => 'col-md-4',
                'class' => 'select2-nonserverside',
                'options' => $this->m_master->get_dropdown($this->table, $this->table_id_key, 'name', false),
            ),
            array(
                'id' => 'name',
