...
class Negara extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->perm = 'master/negara';
        $this->table_id_key = 'negara' . '_id'; // 'warehouse_sub_id';
        ...
        $this->data['table'] = [
            'columns' => [
                ...
                '1' => ['name' => 'a.code', 'title' => 'Kode Negara', 'filter' => ['type' => 'text'], 'width' => '10%', 'class' => 'default-sort', 'sort' => 'asc'],
