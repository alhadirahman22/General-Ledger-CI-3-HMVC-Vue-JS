...
class Tags extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->perm = 'master/tags';
        $this->table_id_key = 'tag' . '_id'; // 'warehouse_sub_id';
        ...
        $this->data['table'] = [
            'columns' => [
                ...
                '2' => ['name' => 'a.count', 'title' => 'Penggunaan', 'filter' => false, 'class' => 'no-sort', 'sort' => 'asc'],
