...
class Jenis_mutasi extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->perm = 'mutasi/jenis_mutasi';
        $this->table_id_key = 'jenis_mutasi' . '_id'; // 'warehouse_sub_id';
        ...
        $this->data['table'] = [
            'columns' => [
                '0' => ['name' => 'a.name', 'title' => 'Nama', 'width' => '15%', 'filter' => ['type' => 'text'], 'class' => 'default-sort', 'sort' => 'asc'],
                '1' => ['name' => 'a.type_approval', 'title' => 'Type Approval', 'filter' => ['type' => 'dropdown', 'options' => ['' => 'All', '1' => 'Series', '2' => 'Paralel']], 'class' => 'default-sort', 'sort' => 'asc'],
                '2' => ['name' => 'a.museum_id', 'title' => 'Museum', 'filter' => ['type' => 'dropdown', 'options' => $this->m_master->get_dropdown('museums', 'museum_id', 'name', true, 'active = 1')], 'class' => 'default-sort', 'sort' => 'asc'],
    ...
    public function get_list()
    {
        ...
        if ($datas) {
            foreach ($datas->result_array() as $data) {
                ...
                $output['data'][] = array(
                    $data['name'],
                    Jenis_mutasi_model_eloquent::$type_approval[$data['type_approval']],
                    $data['nameMuseum'],
    ...
    public function form($token = '')
    {
        ...
        $form = [
            ...
            array(
                ...
                'form_control_class' => 'col-md-4',
                'class' => 'select2-nonserverside',
                'options' => $this->m_master->get_dropdown('museums', 'museum_id', 'name', false, 'active = 1'),
            ),
    ...
    public function delete($token)
    {
        ...
        try {
            ...
            $act = Jenis_mutasi_model_eloquent::findOrFail($id);
            $act->delete();
